...
\com{ authentication to the NAS \\ 
    A -> RADIUS itself doesn't authenticate the connection }
...
\end{figure}
\com{CHAP is not possible since it needs a password for each user. And it may be possible in a small company, but not in a hotel
    D 
}
