...
\begin{figure}[h]
    \centering
    \includegraphics[page = 67,trim = .3cm 1cm .7cm 3.5cm, clip, width = 0.65\textwidth]{\slides}
...
- \textbf{Data Corruption on Zone File:} An attacker penetrating the zone master could corrupt data on the zone file.
